...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2017 at 04:15 PM
...
CREATE TABLE IF NOT EXISTS `city_based_schooled` (
  `Region` text,
...
CREATE TABLE IF NOT EXISTS `dissable_currently_schooled` (
  `groupage` text,
...
--
-- Table structure for table `ethnicity_table`
--

CREATE TABLE IF NOT EXISTS `ethnicity_table` (
  `ethnicity` text,
  `population` int(11) DEFAULT NULL,
  `population_percentage` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ethnicity_table`
--

INSERT INTO `ethnicity_table` (`ethnicity`, `population`, `population_percentage`) VALUES
('Albanian', 29128, 82.58),
('Greek', 24243, 0.87),
('Macedonian', 5512, 0.2),
...
CREATE TABLE IF NOT EXISTS `female_city_based_schooling` (
  `city` text,
  `illiterates` int(11) DEFAULT NULL,
  `no_diploma` int(11) DEFAULT NULL,
  `primary` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gender_based_dissabled_schooled` (
  `gender` text,
  `never_attended` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `highest_education_achieved` (
...
--
-- Table structure for table `household_area_table`
--

CREATE TABLE IF NOT EXISTS `household_area_table` (
  `lloji_njef` text,
  `njef_urbane` int(11) DEFAULT NULL,
  `njef_rurale` int(11) DEFAULT NULL,
  `anetare_urbane` int(11) DEFAULT NULL,
  `anetare_rurale` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `household_area_table`
--

INSERT INTO `household_area_table` (`lloji_njef`, `njef_urbane`, `njef_rurale`, `anetare_urbane`, `anetare_rurale`) VALUES
('NJEF pa berthame familjare', 41222, 18541, 59343, 30155),
('NJEF me nje berthame familjare', 330536, 252531, 1211235, 1016797),
('NJEF me dy ose me shume berthama familjrare', 34136, 37855, 195595, 226170),
('NJEF me berthame jo te vlefshme', 3415, 4026, 19011, 26233);
...
CREATE TABLE IF NOT EXISTS `illeterate` (
...
CREATE TABLE IF NOT EXISTS `male_city_based_schooling` (
  `city` text,
  `illiterates` int(11) DEFAULT NULL,
  `no_diploma` int(11) DEFAULT NULL,
  `primary` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `population_by_city` (
  `region` text,
  `population` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `region_based_currently_schooled` (
...
CREATE TABLE IF NOT EXISTS `returned_people` (
  `groupage` text,
...
--
-- Table structure for table `statical_test_person.cvs`
--

CREATE TABLE IF NOT EXISTS `statical_test_person.cvs` (
...
--
-- Dumping data for table `statical_test_person.cvs`
--

INSERT INTO `statical_test_person.cvs` (`id`, `name`, `age`, `email`, `phone`) VALUES
(1, 'Livia', 21, 'manolivia95@gmail.com', '0693787949'),
(2, 'Alisa', 18, 'manoalisa98@gmail.com', '0695490017');
...
CREATE TABLE IF NOT EXISTS `total_returned_people` (
  `year` text,
  `total` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
