...
<nav class="w3-sidenav w3-teal" style="width: 21%">
    <ul class="w3-ul w3-hoverable">
        ...
        <li class="w3-hover-blue">
            <a href="views/education.view.php">Arsimi</a>
        </li>
        <li class="w3-hover-blue">
            <a href="views/disabled.view.php">Njerezit me aftesi te kufizuar</a>
        </li>
        <li class="w3-hover-blue">
            <a href="views/movement.view.php">Shperndarja e popullsise</a>
        </li>
    </ul>
    <br>
    <br>
